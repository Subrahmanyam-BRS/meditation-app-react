    ...
    <main role="main" className="pt-0">
      <div className="app">
        ...
        <div className="time-select">
          <button onClick={() => handleTimeSelect(120)} data-time="120">2 Minutes</button>
          <button onClick={() => handleTimeSelect(300)} data-time="300" className="medium-mins">5 Minutes</button>
          <button onClick={() => handleTimeSelect(600)} data-time="600" className="long-mins">10 Minutes</button>
        </div>
        <div className="player-container">
          <audio ref={songRef} className="song">
            <source src="assets/sounds/rain.mp3" />
          </audio>
          <img ref={playRef} src="assets/svg/play.svg" className="play" onClick={handlePlayPause} />
          ...
          <img src="assets/svg/replay.svg" className="replay position-absolute bottom-0" onClick={handleReplay} />
          <h3 className="time-display">{timeDisplay}</h3>
        </div>
        <div className="sound-picker">
          <button onClick={() => handleSoundClick("assets/sounds/rain.mp3", "assets/video/rain.mp4")} data-sound="assets/sounds/rain.mp3" data-video="assets/video/rain.mp4"><img src="assets/svg/rain.svg" alt="" /></button>
          <button onClick={() => handleSoundClick("assets/sounds/beach.mp3", "assets/video/beach.mp4")} data-sound="assets/sounds/beach.mp3" data-video="assets/video/beach.mp4"><img src="assets/svg/beach.svg" alt="" /></button>
        </div>
      </div>
    </main>
  );
